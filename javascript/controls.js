...
IsoMap.prototype.mdownEdit = function(ev) {
	var self = this;
...
IsoMap.prototype.mmoveEdit = function(ev) {
	var self = this;
...
IsoMap.prototype.initControls = function(parent) {
	...
	if(self.readOnly) {
		...
		parent.addEventListener('mousedown', self.mdownEdit.bind(self), false);	
		parent.addEventListener('mousemove', self.mmoveEdit.bind(self), false);
